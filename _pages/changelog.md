...
- All files translated to English and combined in a single download

#### Bug Fixes

- Numerous small fixes to dialoges thanks to malaise_chalk and DweltVauller
...
- script and dialogue fixes related to 1.15 update from Nevada Band

#### Script Patch Fixes

- merged/updated multiple scripts for 1.15 update 
